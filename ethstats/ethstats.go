...
import (
	...
	ethproto "github.com/embreum/go-embreum/eth/protocols/eth"
...
type backend interface {
	...
	SyncProgress() embreum.SyncProgress
}
...
// Service implements an Embreum netstats reporting daemon that pushes local
