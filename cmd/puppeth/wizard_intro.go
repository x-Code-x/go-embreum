...
// setting up a new or managing an existing Embreum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Embreum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Embreum network down to  |")
	...
	log.Info("Administering Embreum network", "name", w.network)
