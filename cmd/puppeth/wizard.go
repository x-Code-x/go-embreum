...
type wizard struct {
	...
	services map[string][]string   // Embreum services known to be running on servers
...
// converts it to an Embreum address. If an empty line is entered, the default
// value is returned.
