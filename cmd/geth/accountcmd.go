...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Embreum presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Embreum presale wallet",
				ArgsUsage: "<keyFile>",
...
between embreum nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another embreum instance,
