...
// mapped from textual names used in the tests below to actual Embreum private
...
// address retrieves the Embreum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Embreum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/Embreum/go-ethereum/issues/17593). Whilst this
