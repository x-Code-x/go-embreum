...
// ecrecover extracts the Embreum account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Embreum address
...
// Embreum testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Embreum address of the signing key
...
// Author implements consensus.Engine, returning the Embreum address recovered
