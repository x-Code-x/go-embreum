...
// Package accounts implements high level Embreum account management.
package accounts
...
// Account represents an Embreum account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Embreum account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(bases []DerivationPath, chain embreum.ChainStateReader)
