...
// Package state provides a caching layer atop the Embreum state trie.
package state
...
// StateDB structs within the embreum protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/Embreum/go-ethereum/pull/16485#issuecomment-380438527),
