...
// NewID calculates the Embreum fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Embreum fork ID from an existing chain instance.
