...
import (
	...
	"github.com/Embreum/go-ethereum/core/state/snapshot"
	...
	"github.com/Embreum/go-ethereum/p2p/msgrate"
...
// Syncer is an Embreum account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Embreum state over the
// snap protocol.
