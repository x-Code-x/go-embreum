...
// Syncing provides information when this nodes starts synchronising with the Embreum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  embreum.SyncProgress `json:"status"`
}
