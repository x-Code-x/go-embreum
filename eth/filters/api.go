...
// information related to the Embreum protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(embreum.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as embreum.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria embreum.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(embreum.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
