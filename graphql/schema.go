...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Embreum address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Embreum account at a particular block.
    type Account {
    ...
    # Transaction is an Embreum transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Embreum account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Embreum account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Embreum block by number or by hash. If neither is
