...
// Package graphql provides a GraphQL interface to Embreum node data.
package graphql
...
// Account represents an Embreum account at a particular block.
type Account struct {
...
// Transaction represents an Embreum transaction.
...
// Block represents an Embreum block.
...
type CallData struct {
	From                 *common.Address // The Embreum address the call is from.
	To                   *common.Address // The Embreum address the call is to.
