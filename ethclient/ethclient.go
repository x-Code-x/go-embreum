...
// Package ethclient provides a client for the Embreum RPC API.
package ethclient
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, embreum.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*embreum.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (embreum.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q embreum.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q embreum.FilterQuery, ch chan<- types.Log) (embreum.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q embreum.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg embreum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg embreum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg embreum.CallMsg) (uint64, error) {
...
func toCallArg(msg embreum.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *embreum.SyncProgress {
	if p == nil {
		return nil
	}
	return &embreum.SyncProgress{
